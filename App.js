...
const image = { uri: "https://i.pinimg.com/564x/d4/79/35/d479359444438e53a87e3fcd7a752b0e.jpg" };
        ...
        <ActivityIndicator />
          ...
          <View>
            <View style={styles.head}>
              ...
              <Text style={styles.topText}>This is weather-app are test task for SimbirSoft!</Text>
              <Text style={styles.mainText} data={titleCity}>{titleCity}</Text>
            </View>
